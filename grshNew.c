...
//After careful planning and implementation of the shell, process functions, and the commands
//specified in the desciption, most of the assignment - specifically paths, the Process architecture,
//batch mode, parallel commands, and the checkOnlySpace function - was adopted from a shell
//written by user Saggarwal9 on github.  
