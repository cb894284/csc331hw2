...
//After planning and implementation of the shell and process functions, most of the
//assignment - specifically paths, commands to be implemented, the Process architecture,
